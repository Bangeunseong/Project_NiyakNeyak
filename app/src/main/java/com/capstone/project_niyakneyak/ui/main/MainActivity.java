    ...
    class ItemSelectionListener implements NavigationBarView.OnItemSelectedListener{
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            if(item.getItemId() == R.id.menu_main){
                ...
                if(currentFragmentId == R.id.alarmListFragment) navController.navigate(R.id.action_alarmListFragment_to_settingFragment);
                else if(currentFragmentId == R.id.mainPageFragment) navController.navigate(R.id.action_mainPageFragment_to_settingFragment);
